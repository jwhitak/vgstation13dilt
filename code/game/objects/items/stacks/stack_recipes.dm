...
/datum/stack_recipe/proc/build(var/mob/user, var/obj/item/stack/S, var/multiplier = 1, var/turf/construct_loc)
	...
	if(start_unanchored)
		var/obj/A = O
		A.anchored = 0
	var/atom/put_in_hand = finish_building(user, S, O)
	...
	if (S.amount<=0)
		...
		if(put_in_hand && istype(put_in_hand,/obj/item))
			user.put_in_hands(put_in_hand)
	if(istype(put_in_hand))
		put_in_hand.add_fingerprint(user)
...
/datum/stack_recipe/dorf/New(title, result_type, req_amount = 1, res_amount = 1, max_res_amount = 1, time = 0, one_per_turf = 0, on_floor = 0, start_unanchored = 0, other_reqs = list(), z_up_required = 0, z_down_required = 0, inherit_material = TRUE, gen_quality = FALSE)
	..()
...
/datum/stack_recipe/dorf/finish_building(mob/user, var/obj/item/stack/S, var/obj/R)
	if(inherit_material)
		...
		if(gen_quality)
			...
			R.name = "[lowertext(mat.name)] [R.name]"
			if(mat.color_effect && R.quality >= 5)
				R.dorfized = new(dorf_colorize(R, seteffect = R.material_type.color_effect))
			else
				R.dorfized = new(dorf_colorize(R, R.material_type.color))
			R.update_icon()
	return 1
...
/datum/stack_recipe/blacksmithing/New(title, result_type, req_amount = 1, res_amount = 1, max_res_amount = 1, time = 0, one_per_turf = 0, on_floor = 0, start_unanchored = 0, other_reqs = list(), z_up_required = 0, z_down_required = 0, inherit_material = FALSE, gen_quality = FALSE, required_strikes = 0)
	..()
...
var/datum/stack_recipe_list/blacksmithing_recipes = new("blacksmithing recipes", list(
	...
	new/datum/stack_recipe/blacksmithing("sledgehammer head", /obj/item/item_head/sledgehammer_head,			8, time = 8 SECONDS, required_strikes = 13),
	...
	new/datum/stack_recipe/blacksmithing("buckler",			/obj/item/item_head/buckler,			5,	time = 5 SECONDS, required_strikes = 6),
	...
	"accessories",
	new/datum/stack_recipe/blacksmithing("sword crossguard", /obj/item/guard/cross_guard,			2, time = 5 SECONDS, required_strikes = 4),
	new/datum/stack_recipe/blacksmithing("sword barguard", /obj/item/guard/bar_guard,				2, time = 5 SECONDS, required_strikes = 4),
	new/datum/stack_recipe/blacksmithing("metal handle", /obj/item/handle,							4, time = 5 SECONDS, required_strikes = 5),
	new/datum/stack_recipe/blacksmithing("sword pommel", /obj/item/pommel,							1, time = 5 SECONDS, required_strikes = 4),
	"tools",
	new/datum/stack_recipe/blacksmithing("fork", /obj/item/weapon/kitchen/utensil/fork,				1, time = 5 SECONDS, required_strikes = 4),
	new/datum/stack_recipe/blacksmithing("spoon", /obj/item/weapon/kitchen/utensil/spoon,			1, time = 5 SECONDS, required_strikes = 4),
	new/datum/stack_recipe/blacksmithing("plate", /obj/item/trash/plate,							1, time = 5 SECONDS, required_strikes = 4),
	new/datum/stack_recipe/blacksmithing("screwdriver", /obj/item/tool/screwdriver,					1, time = 5 SECONDS, required_strikes = 4),
	new/datum/stack_recipe/blacksmithing("wirecutters", /obj/item/tool/wirecutters,					2, time = 5 SECONDS, required_strikes = 5),
	new/datum/stack_recipe/blacksmithing("crowbar", /obj/item/tool/crowbar,							4, time = 5 SECONDS, required_strikes = 6),
	new/datum/stack_recipe/blacksmithing("toolbox", /obj/item/weapon/storage/toolbox,				8, time = 5 SECONDS, required_strikes = 9),
	new/datum/stack_recipe/blacksmithing("frying pan", /obj/item/weapon/reagent_containers/pan, 	10, time = 5 SECONDS, required_strikes = 9),
	"other items",
	new/datum/stack_recipe/dorf("chains",				 /obj/item/stack/chains, 					2, 1, 20, time = 5 SECONDS),
	new/datum/stack_recipe/dorf("dorf chair",              /obj/structure/bed/chair,                2, one_per_turf = 1, time = 15, on_floor = 1, gen_quality = TRUE),
	new/datum/stack_recipe/blacksmithing("armor plate", /obj/item/weapon/armor_plate/smithed,		1, time = 5 SECONDS, required_strikes = 4),
	))
...
var/list/datum/stack_recipe/wood_recipes = list (
	...
	"woodworking",
	new/datum/stack_recipe/dorf("training sword", /obj/item/weapon/melee/training_sword, 4, time = 12,	on_floor = 1),
	new/datum/stack_recipe/dorf("item handle",		/obj/item/handle,					1,		time = 2 SECONDS),
	new/datum/stack_recipe/dorf("dorf chair",              /obj/structure/bed/chair,                 2, one_per_turf = 1, on_floor = 1, gen_quality = TRUE),
	)
...
var/list/datum/stack_recipe/brass_recipes = list (
	...
	null,
	new/datum/stack_recipe/dorf("dorf chair", /obj/structure/bed/chair, one_per_turf = TRUE, on_floor = TRUE, gen_quality = TRUE),
	new/datum/stack_recipe/dorf("training sword", /obj/item/weapon/melee/training_sword, 4, time = 12,	on_floor = TRUE, gen_quality = TRUE),
	)
